...
export const AppIconsPack = {
    name: 'app',
    icons: {
        'lazada': IconProvider(require('../assets/images/icon-laz.png')),
        'shopee': IconProvider(require('../assets/images/icon-shopee.png')),
        'tiki': IconProvider(require('../assets/images/icon-tiki.png')),
